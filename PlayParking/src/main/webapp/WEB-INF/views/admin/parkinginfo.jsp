...
<body
	...
	<div class="module" id="updateform">
		...
		<form class="form-horizontal row-fluid" action="parkinginfo.do"
			method="get">

			<!-- 주차장정보수정 -->
			<label class="control-label" for="basicinput"
				style="margin-top: 6%; margin-right: 5%;"><font size="3"
				face="HU미드나잇120">이름</font></label>
			<p class="text-success" style="margin-top: 6%; margin-left: 5%;">${parking.pname}</p>

			<label class="control-label" for="basicinput"
				style="margin-top: 4%; margin-right: 5%;"><font size="3"
				face="HU미드나잇120">주차요금</font></label>
			<p class="text-success" style="margin-top: 6%; margin-left: 5%;">${parking.pfare}
				원</p>

			<label class="control-label" for="basicinput"
				style="margin-top: 4%; margin-right: 5%;"><font size="3"
				face="HU미드나잇120">추가요금</font></label>
			<p class="text-success" style="margin-top: 6%; margin-left: 5%;">${parking.platefare}
				원</p>

			<label class="control-label" for="basicinput"
				style="margin-top: 4%; margin-right: 5%;"><font size="3"
				face="HU미드나잇120">연락처</font></label>
			<p class="text-success" style="margin-top: 6%; margin-left: 5%;">${parking.pphone}</p>

			<label class="control-label" for="basicinput"
				style="margin-top: 4%; margin-right: 5%; margin-bottom: 5%;"><font
				size="3" face="HU미드나잇120">수용차수</font></label>
			<p class="text-success"
				style="margin-top: 6%; margin-left: 5%; margin-bottom: 5%;">${parking.pamount}</p>
