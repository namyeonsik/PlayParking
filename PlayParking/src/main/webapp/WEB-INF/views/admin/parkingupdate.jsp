...
<body
					...
					<ul class="nav pull-right">
						...
						<li class="nav-user dropdown"><a href="#"
							...
							<ul class="dropdown-menu">
								<li><a href="parkinginfo.do"><font face="HU미드나잇120">주차장
											정보</font></a></li>
								<li><a href="parkingupdate.do"><font face="HU미드나잇120">주차장
											정보 수정</font></a></li>
								<li class="divider"></li>
	...
	<div class="module" id="updateform">
		...
		<form class="form-horizontal row-fluid" action="parkingupdate.do"
			method="post" style="width: 100%;">
			<!-- 주차장정보수정 -->
			<div class="controls">
				<input type="hidden" id="basicinput"
					style="margin-bottom: 5%; margin-top: 8%" value="${parking.pid}"
					name="pid" class="span8">
			</div>
			<label class="control-label" for="basicinput" style="margin-top: 6%"><font
				face="HU미드나잇120" size="3">이름</font></label>
			<div class="controls">
				<input type="text" id="basicinput"
					style="margin-bottom: 5%; margin-top: 8%" value="${parking.pname}"
					name="pname" class="span8">
			</div>
			<label class="control-label" for="basicinput"><font
				face="HU미드나잇120" size="3">주차요금</font></label>
			<div class="controls">
				<input type="text" id="basicinput" style="margin-bottom: 5%"
					value="${parking.pfare}" name="pfare" class="span8">
			</div>
			<label class="control-label" for="basicinput"><font
				face="HU미드나잇120" size="3">추가요금</font></label>
			<div class="controls">
				<input type="text" id="basicinput" style="margin-bottom: 5%"
					value="${parking.platefare}" name="platefare" class="span8">
			</div>
			<label class="control-label" for="basicinput"><font
				face="HU미드나잇120" size="3">연락처</font></label>
			<div class="controls">
				<input type="text" id="basicinput" style="margin-bottom: 5%"
					value="${parking.pphone}" name="pphone" class="span8">
			</div>
			<label class="control-label" for="basicinput"><font
				face="HU미드나잇120" size="3">수용차수</font></label>
			<div class="controls">
				<input type="text" id="basicinput" style="margin-bottom: 10%"
					value="${parking.pamount}" name="pamount" class="span8">
			</div>
			<div class="form-group">
				<div class="col-lg-10 col-lg-offset-2">
					<button type="submit" class="btn btn-primary"
						style="margin-left: 33%; margin-right: 5%; margin-bottom: 5%">Complete</button>
					<button type="reset" onclick="adminmain.do" class="btn btn-default"
