										...
										<div class="stream-headline">
											<h5 class="stream-author">
												<label class="control-label" for="basicinput"><font
													face="HU미드나잇120">Title</font></label> <input type="text"
													name="ntitle" value="${notice.ntitle}"> <font
													face="HU미드나잇120"> <small> <c:set var="d"
															value="${notice.ndate}" /> <fmt:formatDate value="${d}"
											...
											<div class="stream-text">
												<div class="control-group">
													<label class="control-label" for="basicinput"><font
														face="HU미드나잇120">Content</font></label>
													<div class="controls">
