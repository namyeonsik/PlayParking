...
<form name="chulfrm" action="reservationupdate.do" method="post"
	onsubmit="call2()">
	<fmt:formatNumber value="${naga }" type="number" var="extrapaypoint" />
	<br>
	<h1>예약번호: ${rid }</h1>
	<h1>추가요금: ${extrapaypoint}</h1>
	<input type="hidden" name="rid" value="${rid }"> <input
		type="hidden" name="naga" value="${naga }"> <input
		type="submit" class="btn btn-inverse" value="출차확인"
