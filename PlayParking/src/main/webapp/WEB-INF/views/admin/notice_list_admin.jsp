						...
						<div class="module-head" style="height: 30px;">
							...
							<div class="pull-right">
								<a class="btn btn-primary"
									href='noticeinsert.do?cnt=${maxnno+1}'>등록</a>
							</div>
						</div>
						<div class="module-body table">
							<table class="table table-message">
								<tbody>
									<tr class="heading">
										<td>No</td>
										<td class="cell-title"><font face="HU미드나잇120">공지사항
												제목</font></td>
										<td class="cell-title"><font face="HU미드나잇120">주차장
												이름</font></td>
										<td class="cell-title"><font face="HU미드나잇120">주차장
												관리인</font></td>
										<td class="cell-title"><font face="HU미드나잇120">게시
												날짜</font></td>
									</tr>
									...
									<c:forEach items="${noticelist}" var="n">
										<tr class="read starred">
											...
											<td class="cell-title"><a
												href='checktext.do?nno=${n.nno}'><font face="HU미드나잇120">${n.ntitle}</font></a></td>
											<td class="cell-title"><font face="HU미드나잇120">${pname}</font></td>
											<td><font face="HU미드나잇120">${n.aid}</font></td>
											<td><font face="HU미드나잇120"> <c:set var="d"
														value="${n.ndate}" /> <fmt:formatDate value="${d}"
