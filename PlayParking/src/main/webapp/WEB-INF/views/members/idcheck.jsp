...
<form class="form-horizontal" action="idcheck.do" method="post" style="width: 65%">
    <div id="title" style="margin-left: 40%; width: 100%;">
    <h3><font face="HU미드나잇120">ID 중복확인</font></h3>
    </div>
    <input type="text" name="mid" id="mid" class="form-control input-sm" placeholder="id입력">
    <button type="button" style=" float: right; font-family: HU미드나잇120;" class="btn btn-default">ID중복확인</button>
