                        ...
                        <ul>
                           <!-- data-lazyload: 홈배경 -->
                            ...
                            <li data-transition="random" data-slotamount="8" data-masterspeed="450"  data-saveperformance="off">
                                <img src="${pageContext.request.contextPath}/resources/geass/images/revslider/dummy.png"  alt="slidebg2" data-lazyload="${pageContext.request.contextPath}/resources/geass/images/homeslider/slide00_1.jpg"  data-kenburns="on" data-bgposition="center bottom" data-duration="4200" data-bgfit="115" data-bgfitend="100" data-bgpositionend="center center" data-bgrepeat="no-repeat">
                                
                                <div class="tp-caption rev-title sft stt" data-x="100" data-hoffset="-150" data-y="145" data-start="950" data-speed="1200">WHY</div>
