                ...
                <nav class="navbar navbar-default navbar-transparent" role="navigation">
                    <div class="container">
                        ...
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand navbar-brand-img" href="membermain.do"><img src="${pageContext.request.contextPath}/resources/geass/images/logo-park.png" class="img-responsive logo-white" alt="logo"><img src="${pageContext.request.contextPath}/resources/geass/images/logo.png" class="img-responsive logo-fixed" alt="logo"></a>
                        </div>
                        ...
                        <ul>
                           <!-- data-lazyload: 홈배경 -->
                            ...
                            <li data-transition="random" data-slotamount="8" data-masterspeed="450"  data-saveperformance="off">
                                <img src="${pageContext.request.contextPath}/resources/geass/images/revslider/dummy.png"  alt="slidebg2" data-lazyload="${pageContext.request.contextPath}/resources/geass/images/homeslider/slide00.jpg"  data-kenburns="on" data-bgposition="center bottom" data-duration="4200" data-bgfit="115" data-bgfitend="100" data-bgpositionend="center center" data-bgrepeat="no-repeat">
                                
                                <div class="tp-caption rev-title rev-border sft stt" data-x="center" data-y="210" data-start="1000" data-speed="1000">WHY <span class="yellow-color">?</span></div>
                            ...
                            <li data-transition="random" data-slotamount="8" data-masterspeed="450" data-saveperformance="off">
                                <img src="${pageContext.request.contextPath}/resources/geass/images/revslider/dummy.png"  alt="slidebg3" data-lazyload="${pageContext.request.contextPath}/resources/geass/images/homeslider/slide00.jpg" data-kenburns="on" data-bgposition="center bottom" data-duration="5200" data-bgfit="115" data-bgfitend="100" data-bgpositionend="center center" data-bgrepeat="no-repeat">
                                <div class="tp-caption rev-title sft stt" data-x="center" data-hoffset="-125" data-y="145" data-start="600" data-speed="1000">HOW</div>
                                <div class="tp-caption rev-title lightblue-color sfb stb" data-x="center" data-hoffset="125" data-y="145" data-start="600" data-speed="1000">?</div>
                            ...
                            <li data-transition="random" data-slotamount="8" data-masterspeed="450" data-saveperformance="off">
                                ...
                                <div class="tp-caption rev-title rev-border sft stt" data-x="center" data-y="210" data-start="1000" data-speed="1000">Effect <span class="yellow-color"></span></div>
