...
public class ParkingDTO {
	...
	public ParkingDTO(int pid, int pfare, double pwidth, double plength,
			int platefare, int pamount, int pcount, String pname,
			String plocation, String pphone, double x, double y, String pimage,
			String pimage2, String pimage3, String paddress, String ptip) {
		super();
		this.pid = pid;
		this.pfare = pfare;
		this.pwidth = pwidth;
